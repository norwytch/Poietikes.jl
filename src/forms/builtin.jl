...
function _register_builtins!()
    ...
    register!(FreeVerse(), Latin())
    register!(Hexameter(), Latin())
    register!(FreeVerse(), Arabic())
    register!(Tawil(), Arabic())
    register!(Kamil(), Arabic())
    register!(FreeVerse(), Norse())
    register!(Drottkvaett(), Norse())
    register!(FreeVerse(), Welsh())
    register!(Cywydd(), Welsh())
